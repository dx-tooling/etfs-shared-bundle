...
final class NoAssociativeArraysAcrossBoundariesRuleTest extends TestCase
{
    public function testReportsErrorsForAssociativeAndNestedArrays(): void
    {
        ...
        foreach ($fixtures as $fixture) {
            [$exitCode, $errors] = $this->runPhpStan([
                'EnterpriseToolingForSymfony\\SharedBundle\\PhpStan\\Rules\\NoAssociativeArraysAcrossBoundariesRule',
            ], $fixture);
    ...
    public function testPassesForSimpleLists(): void
    {
        $root    = realpath(__DIR__ . '/../../../..');
        $fixture = $root . '/tests/Fixtures/PhpStan/NoAssociativeArraysAcrossBoundaries/Good/PublicReturnSimpleList.php';
